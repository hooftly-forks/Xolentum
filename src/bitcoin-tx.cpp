...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " xolentum-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  xolentum-tx [options] <hex-tx> [commands]  Update hex-encoded xolentum transaction\n" +
            "or:     xolentum-tx [options] -create [commands]   Create hex-encoded xolentum transaction\n" +
            "\n";
