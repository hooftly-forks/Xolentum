...
const char * const BITCOIN_CONF_FILENAME = "xolentum.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Xolentum";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Xolentum";
#else
    // Unix
    return pathRet / ".xolentum";
#endif
#endif
}
