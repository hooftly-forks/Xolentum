...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.xolentum.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.xolentumtools.com");
        vSeeds.emplace_back("dnsseed.xolentumpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.xolentumtools.com");
        vSeeds.emplace_back("seed-b.xolentum.loshan.co.uk");
