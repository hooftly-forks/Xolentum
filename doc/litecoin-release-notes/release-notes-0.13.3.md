Xolentum Core version 0.13.3 is now available from:

  <https://download.xolentum.org/xolentum-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/xolentum-project/xolentum/blob/0.13/src/chainparams.cpp#L214).
