# Support for Output Descriptors in Xolentum Core

Since Xolentum Core v0.17, there is support for Output Descriptors. This is a
...
on Xolentum's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Xolentum Core wallets, a convenience function `combo` is
