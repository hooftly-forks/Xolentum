...
"""Verify that starting xolentum with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start xolentum with -h for help text")
        ...
        self.log.info("Start xolentum with -version for version information")
        ...
        self.log.info("Start xolentumd with -fakearg to make sure it does not start")
